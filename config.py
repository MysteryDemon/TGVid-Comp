...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6386303762:AAFeRUduL2Slo9pUx9EHicLqJsHT4qxpNrg") # ⚠️ Required
    ...
    # Other Configs 
    ADMIN = int(os.environ.get("ADMIN", "6772345894")) # ⚠️ Required
    LOG_CHANNEL = int(os.environ.get('LOG_CHANNEL', '-1001852063565')) # ⚠️ Required
